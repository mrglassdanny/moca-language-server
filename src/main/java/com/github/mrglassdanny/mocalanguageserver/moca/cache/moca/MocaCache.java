...
public class MocaCache {
    ...
    public MocaCache() {
        ...
        {
            MocaFunction maxFunc = new MocaFunction("max", new String[] { MocaFunction.VARIABLE_LENGTH_ARGUMENT },
                    "Maximum [expr] as a MocaType.INTEGER");
            MocaFunction minFunc = new MocaFunction("min", new String[] { MocaFunction.VARIABLE_LENGTH_ARGUMENT },
            ...
            MocaFunction dateFunc = new MocaFunction("date", new String[] { "expr" }, "[expr] as a MocaType.DATETIME");
            ...
            MocaFunction floatFunc = new MocaFunction("float", new String[] { "expr" }, "[expr] as a MocaType.DOUBLE");
            MocaFunction intFunc = new MocaFunction("int", new String[] { "expr" }, "[expr] as a MocaType.INTEGER");
            ...
            MocaFunction iifFunc = new MocaFunction("iif", new String[] { "expr", "true-expr", "false-expr" },
                    "If [expr] is true, it returns [true-expr]; if not, it returns [false-expr]");
