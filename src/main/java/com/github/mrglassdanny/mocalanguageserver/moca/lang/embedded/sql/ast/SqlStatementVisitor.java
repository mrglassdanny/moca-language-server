package com.github.mrglassdanny.mocalanguageserver.moca.lang.embedded.sql.ast;
...
/*
    Special visitor for our sql scripts, mostly copied from net.sf.jsqlparser.util.TableNamesFinder class.
*/

public class SqlStatementVisitor implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor,
        SelectItemVisitor, StatementVisitor {

    public ArrayList<Table> tables;
    public ArrayList<String> tableNames;
    public HashMap<String, String> aliasedTableNames;
    public HashMap<String, SubSelect> subqueries;
    public boolean allowColumnProcessing = false;
    public ArrayList<String> otherItemNames;
    public SimpleNode rootNode; // TODO - maybe should do this as an array..
    ...
    public void visit(Table table) {
        ...
        if (table != null) {
            ...
            if (alias != null) {
                ...
                aliasedTableNames.put(alias.getName(), tableName);
            }

            String tableWholeName = extractTableName(table);
            if (!otherItemNames.contains(tableWholeName.toLowerCase()) && !tableNames.contains(tableWholeName)) {
    ...
    public void visit(SubSelect subSelect) {
        ...
        if (alias != null) {
            subqueries.put(alias.getName(), subSelect);
    ...
    public void visit(Column column) {
        ...
        if (allowColumnProcessing && column.getTable() != null && column.getTable().getName() != null) {
